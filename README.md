...
Expected Output
When executed, the script generates a structured output displaying each team member’s details in a clear and readable format:
...
Considerations
This script is designed for small, fixed datasets and provides a straightforward way to display team member details. However, for larger datasets or cases where information may change frequently, using data structures like dictionaries or lists would improve maintainability and scalability.
